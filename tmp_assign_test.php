<?php /* Template Name: tmp_assign_test */ ?>
			...
			<div id = "main_container">
					<div id = "sub_container">
						...
						echo '<table id = "display_table_data">
							 <tr class = "table_row"><td class = "table_heading" colspan = "8">Student List</th></tr>
							 <tr class = "table_row">
							 <th> Student Id</th>
							 <th> First Name </th>
							 <th> Last Name </th>
							...
							$sql="SELECT student_id, fname, lname, email_id, phone_no, course_name, test_category from student LIMIT $start, $limit";
							...
							<td class = "use_address"><i class="fa fa-file-text" aria-hidden="true"></i></td>
							</tr>';
							}
							echo "</table>";
								//simple pagination
...
$(document).ready(function(){
    ...
    window.location = 'http://localhost/wordpress_onlinetest/assign-test-page?student_id='+student_id;
    });
});
