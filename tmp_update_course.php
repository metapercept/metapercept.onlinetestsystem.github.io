<?php /* Template Name: tmp_update_course */ ?>
...
include_once("connection.php");
 ...
 <div class = "top_btns" style="margin-bottom:10px;">
	...
	<div id="primary" class="content-area boxed">
		<form action="" method = "post" id = "frm_update_course">
			<div id = "main_container">
					<div id = "sub_container">
						...
						echo '<table id = "display_table_data">
							 <tr class = "table_row"><td class = "table_heading" colspan = "4">Update Course</th></tr>
							 <tr class = "table_row">
							 <th> Course Id</th>
							 <th> Description </th>
							 <th> Start Date </th>
...
$(document).ready(function(){
    ...
    window.location = 'http://localhost/wordpress_onlinetest/update-course-page?course_id='+course_id;
    });
});
