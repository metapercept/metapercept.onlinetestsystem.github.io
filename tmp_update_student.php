<?php /* Template Name: tmp_update_student */ ?>
...
include_once("connection.php");
 ...
 <div class = "top_btns" style="margin-bottom:10px;">
	...
	<div id="primary" class="content-area boxed">
		<form action="" method = "post" id = "frm_update_student">
			<div id = "main_container">
					<div id = "sub_container">
						...
						echo '<table id = "display_table_data">
							 <tr class = "table_row"><td class = "table_heading" colspan = "7">Update Student</th></tr>
							 <tr class = "table_row">
							 <th> Student Id </th>
							 <th> First Name </th>
							 <th> Last Name </th>
...
$(document).ready(function(){
    ...
    window.location = 'http://localhost/wordpress_onlinetest/update-student-page?student_id='+student_id;
    });
});
